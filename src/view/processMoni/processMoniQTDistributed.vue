...
type = "flex" >
  ...
  el - input @keyup.enter.native = "getByKey"
v - model.trim = "custName_la"
...
placeholder = "请输入证件号码" > < /el-input> <
  ...
  el - input @keyup.enter.native = "getByKey"
v - model.trim = "applySubNo"
placeholder = "请输入进价编号" > < /el-input> <
  /el-col> <
  el - col: span = "6" >
  <
  span class = "keywordText" > 进件机构 < /span> <
  el - input @keyup.enter.native = "getByKey"
v - model.trim = "appOrgCode"
placeholder = "请输入进件机构" > < /el-input> <
  /el-col> <
  /el-row> <
...
placeholder = "请选择产品名称" >
  ...
  /p> <
  el - option v -
  for = "item in proNames": key = "item.id": label = "item.proName": value = "item.id" >
  <
  ...
  el - select v - model = "taskNodeName"
placeholder = "请选择" >
  <
  el - option v -
  for = "item in taskNodes": key = "item.value": label = "item.label": value = "item.value" >
  <
  /el-option> <
  /el-select> <
  /el-col> <
...
placeholder = "请选择" >
  <
  el - option v -
  for = "item in taskTypes": key = "item.value": label = "item.label": value = "item.value" >
  <
  /el-option> <
  /el-select> <
  /el-col> <
  ...
  el - input @keyup.enter.native = "getByKey"
v - model.trim = "operatorCode"
placeholder = "请输入当前处理人员" > < /el-input> <
  /el-col> <
  /el-row> <
...
class = "search-btn" >
  <
  el - button class = "btn query"
type = "primary"
@click = "getByKey" > 查询 < /el-button> <
...
@click = "handleItem('trans')" >
  ...
  <
  el - table: data = "moniList"
height = "510"
border show - header highlight - current - row @selection - change = "handleSelectionChange"
@row - click = "selectRow" >
  <
...
width = "50" >
  <
  /el-table-column> <
  el - table - column prop = "emerTypeTxt"
label = "紧急程度"
width = "80" >
  <
  /el-table-column> <
  el - table - column prop = "taskTypeTxt"
label = "任务类型"
min - width = "80" >
  <
  /el-table-column> <
  el - table - column prop = "applySubNo"
label = "进件编号"
min - width = "200" >
  <
  /el-table-column> <
...
min - width = "120" >
  <
  /el-table-column> <
  el - table - column prop = "appOrgCode"
label = "进件机构"
min - width = "100" >
  <
  /el-table-column> <
  el - table - column prop = "taskNodeNameTxt"
label = "任务节点"
min - width = "120" >
  <
  /el-table-column> <
...
@current - change = "changeCurrentPage": current - page.sync = "currentPage": page - sizes = 'pageSizesArr': page - size = 'setPageSize'
layout = "total, sizes, prev, pager, next, jumper": total = 'responseDatas.totalNum' >
  <
  /el-pagination> <
  /div> <
  /div>
  <!-- 流程轨迹 -->
  <
  el - dialog title = "流程轨迹"
custom - class = "trace": visible.sync = "dialogTraceVisible" >
  <
  el - table: data = "traceList"
border show - header highlight - current - row >
  <
  el - table - column type = "index"
label = "序号"
width = "50" >
...
show - overflow - tooltip width = "150" >
  <
  /el-table-column> <
  el - table - column prop = "taskStatusTxt"
label = "任务状态"
width = "80" >
  <
  /el-table-column> <
...
show - overflow - tooltip width = "150" >
  <
  /el-table-column> <
  el - table - column prop = "approvalOpinionTxt"
label = "处理结论"
width = "100" >
  <
  /el-table-column> <
  el - table - column prop = "opinionExplain"
label = "意见说明"
...
@click = "dialogTraceVisible = false" > 返 回 < /el-button> <
  /div> <
  /el-dialog>
  <!-- 任务分派 -->
  <
  ...
  <
  el - form: model = "itemOfLists": rules = "rules"
ref = "ruleForm" >
  <
  div class = "bfc" >
  <
  el - form - item class = "fl"
label = "任务角色": label - width = "formLabelWidth" >
  <
  el - input readonly v - model = "flowRoleName" > < /el-input> <
  /el-form-item> <
  el - form - item class = "fr"
label = "处理人员"
prop = "toUser": label - width = "formLabelWidth" >
  <
  el - select v - model = "itemOfLists.toUser"
placeholder = "请选择处理人员" >
  <
  p style = "height: 34px;line-height: 34px;padding: 0 20px;font-size: 14px;background: #eee;" >
  <
  ...
  /p> <
  el - option v -
  for = "item in flowRoleIds": key = "item.userCode": label = "item.userName": value = "item.userCode" >
  <
...
class = "dialog-footer" >
  ...
  el - button type = "primary"
@click = "taskTransmit('ruleForm')" > 确 定 < /el-button> <
  /div> <
  /el-dialog>
  <!-- 转分派流程轨迹 -->
  <
  el - dialog title = "转分派流程轨迹"
custom - class = "trans": visible.sync = "dialogTransVisible" >
  <
  el - table: data = "transList"
border show - header highlight - current - row >
  <
  el - table - column type = "index"
label = "序号"
...
width = "100" >
  <
  /el-table-column> <
  el - table - column prop = "assignerCode"
label = "转分派人"
width = "110" >
  <
  /el-table-column> <
  el - table - column prop = "assignFromCode"
label = "原任务人"
width = "110" >
  <
  /el-table-column> <
  el - table - column prop = "assignToCode"
label = "现任务人"
width = "110" >
  <
  /el-table-column> <
...
class = "dialog-footer" >
  <
  el - button type = "primary"
@click = "dialogTransVisible = false" > 返 回 < /el-button> <
  /div> <
  /el-dialog> <
  /div> <
  /template>
