...
<template>
  <div class="taskWatting main-div">
    ...
    <!-- 流程轨迹 -->
    <el-dialog title="流程轨迹" :visible.sync="dialogTraceVisible" :modal="false" width="1000px">
    ...
    <!-- 任务分派 -->
    <el-dialog title="任务分派" :visible.sync="dialogAssignVisible" :modal="false">
