  ...
  <div class="taskWatting main-div">
    ...
    <el-dialog title="流程轨迹" width="1000px" :visible.sync="dialogTraceVisible">
      <el-table :data="traceList" height="510" border show-header highlight-current-row>
        ...
        <el-table-column prop="completeTime" label="处理时间" show-overflow-tooltip width="170">
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getProcessMonitorList() {
        ...
        // this.queryParam.proId = this.selectedProName;
      ...
      handleItem(flag) {
        ...
        if (flag === "trace") {
          ...
          this.getTransmitHistoryList(
            this.multipleSelection[0].processInstanceId
          );
        }
      },
