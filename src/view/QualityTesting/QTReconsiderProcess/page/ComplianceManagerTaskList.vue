<template>
  <div class="AntiCaseNum IntegratedQuery">
    <!-- 质检复议流程-合规经理页面- 合规经理任务列表-区域经理用一个，待考虑删除 -->
    <myHead></myHead>
    <div class="content">
      <div class="search">
        <ul>
          <li>
            ...
            <p>
              <label> 客户名称</label>
              <el-input v-model="params.applySubno" placeholder="请输入客户名称"></el-input>
            </p>
            <p>
              <label> 证件号码</label>
              <el-input v-model="params.applySubno" placeholder="请输入证件号码"></el-input>
            </p>
          </li>
          <li>
            <p>
      ...
      <div class="table_wrap">
        <!-- 编辑table -->
        <el-table :data="tableData" style="width: 100%" height="100%" @row-dblclick="handleCurrentChange" @selection-change="handleSelectionChange"
          border>
          ...
          <el-table-column prop="operOrgName" label="差错描述" align='center' min-width="120">
          </el-table-column>
