  ...
  <div class="AntiCaseNum IntegratedQuery">
    ...
    <div class="content">
      ...
      <div class="table_wrap">
        <!-- 编辑table -->
        <el-table :data="tableData" style="width: 100%" height="100%" border @row-click="handleCurrentChange" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="certType" label="证件类型" align='center' min-width="180">
          </el-table-column>
