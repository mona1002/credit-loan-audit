<template>
  <div class="AudioVisualLeft">
    ...
    <!-- 右侧 图片 -->
    <div class="AudioVisual_Img" ref="AudioVisual_Img_ref[0]" @mouseenter="Imgscroll" @mouseleave="ImgScrollRemove">
  ...
  export default {
    ...
    methods: {
      ...
      hid() { //左侧 li 列表
        ...
        this.$refs.AudioVisual_Img_ref[0].style.width = "calc( 100% - 31px)";
      },
      showList() { //左侧 li 列表
        this.showListDiv = true;
        this.$refs.AudioVisual_Img_ref[0].style.width = "calc( 100% - 214px)";
      },
