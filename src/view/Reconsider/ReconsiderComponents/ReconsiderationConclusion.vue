	...
	export default{
		...
		methods:{
		    ...
		    spsure(){
	          ...
	          // 信用负债率
	          /*if(!this.caculData.creditDebitRate || this.caculData.creditDebitRate == 0){
	          	this.caculData.creditDebitRate = 0;
	          }else if(this.caculData.creditDebitRate && this.caculData.creditDebitRate != 0){
	          	this.caculData.creditDebitRate = this.formatNumber(this.caculData.creditDebitRate.replace("%","")/100,2,0);
	          };
	          //内部负债率
	          if(!this.caculData.inteDebitrate || this.caculData.inteDebitrate == 0){
	          	this.caculData.inteDebitrate = 0;
	          }else if(this.caculData.inteDebitrate && this.caculData.inteDebitrate != 0){
	          	this.caculData.inteDebitrate = this.formatNumber(this.caculData.inteDebitrate.replace("%","")/100,2,0);
	          };
	          // 总负债率
	          if(!this.caculData.totalRate || this.caculData.totalRate == 0){
	          	this.caculData.totalRate = 0;
	          }else if(this.caculData.totalRate && this.caculData.totalRate != 0){
	          	this.caculData.totalRate = this.formatNumber(this.caculData.totalRate.replace("%","")/100,2,0);
	          };*/
	           ...
	           this.post('/creauditOpinion/add', {
		        ...
		        inteDebitrate: (this.caculData.inteDebitrate == 0 || this.caculData.inteDebitrate == '') ? 0 : this.formatNumber(this.caculData.inteDebitrate.replace("%","")/100,2,0)*1, //内部负债率
		        totalRate: (this.caculData.totalRate == 0 || this.caculData.totalRate == '') ? 0 : this.formatNumber(this.caculData.totalRate.replace("%","")/100,2,0)*1, // 总负债率
		        ...
		        creditDebitRate: (this.caculData.creditDebitRate == 0 || this.caculData.creditDebitRate == '') ? 0 : this.formatNumber(this.caculData.creditDebitRate.replace("%","")/100,2,0)*1, // 信用负债率
