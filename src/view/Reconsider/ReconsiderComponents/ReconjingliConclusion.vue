...
<template>
  <div class="ReconsiderationConclusion">
    ...
    <div class="huitui jujue">
      <el-dialog title='拒绝原因' :visible.sync="jdialogVisible" :modal="false" width="860px" top="20vh">
        <div class="huituiBody">
          <p class="bodyP">
            <ul>
              <li>
    ...
    <div class="shenpiliucheng">
      <el-dialog title='复议审批轨迹' :visible.sync="sldialogVisible" :modal="false" width="860px" top="20vh">
        <div class="splcBody">
    ...
    methods: {
      ...
      spsure() {
        ...
        this.post('/creauditOpinion/add', {
          ...
          ploanOperId: '', // 批准人员
          creditDebitRate: (this.caculData.creditDebitRate == 0 || this.caculData.creditDebitRate == '' || !this.caculData
            .creditDebitRate) ? 0 : this.caculData.creditDebitRate.replace("%", "") / 100, // 信用负债率
