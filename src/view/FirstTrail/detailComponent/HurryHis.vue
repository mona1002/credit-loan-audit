    ...
    <!-- <div class="address-title">
      ...
      <div style="margin-left:30px;">
        ...
        <el-form-item label="调查结果：" class="item-column1">
          <div style="white-space: pre-wrap;"> {{hurryData.conclusion}}</div>
        </el-form-item> -->
    <!-- </div> -->
    <!-- </el-form> -->
  </div>
