    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item title="房产信息" name="1">
        ...
        <div class="containDiv">
          <el-table :data="borestateList" style="width: 100%" class="house" highlight-current-row border
            @current-change="handleCurrentChange">
            <el-table-column type="index" :index="1" label="序号" min-width="50">
            </el-table-column>
            <el-table-column label="房产类型" prop="estateType" min-width="150">
              <template slot-scope="scope">
                ...
                <el-tooltip class="item" effect="dark" :disabled="scope.row.estateType!=''" content="该项为必填项" placement="right">
                  <el-select v-model="scope.row.estateType" placeholder="请选择">
                    <el-option v-for="item in estateTypes" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column prop="propertyType" label="产权性质" min-width="110">
              <template slot-scope="scope">
            ...
            <el-table-column prop="coveredArea" label="建筑面积[m²]" min-width="110">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.coveredArea!=''" content="请输入10-300"
                  placement="top">
            ...
            <el-table-column prop="unitPrice" label="建筑单价[元]" min-width="120">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.unitPrice!=''" content="请输入100-1000000"
                  placement="top">
            ...
            <el-table-column prop="estateAddress" label="房产地址" min-width="200">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.estateAddress!=''" content="100字以内"
                  placement="top">
            ...
            <el-table-column prop="estateZip" label="邮政编码" min-width="80">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.estateZip!=''" content="请输入6位邮编" placement="top">
                  <el-input v-model="scope.row.estateZip" placeholder="请输入内容" @focus="falseShow(scope.row,'estateZip')"
                    v-on:blur="postcode(scope.row,'estateZip')"></el-input>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column prop="equityRatio" label="产权比例[%]" min-width="100">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.equityRatio!=''" content="请输入0%-100%"
                  placement="top">
            ...
            <el-table-column prop="loanPeriod" label="贷款期限[月]" min-width="110">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.loanPeriod!=''" content="请输入1-360"
                  placement="top">
            ...
            <el-table-column prop="mortgageStatus" label="抵押状况" min-width="110">
              <template slot-scope="scope">
                <el-select v-model="scope.row.mortgageStatus" placeholder="请选择">
                  <el-option v-for="item in mortgageStatuss" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="monthlyPay" label="月供[元]" min-width="80">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.monthlyPay!=''" content="请输入500-500000"
                  placement="top">
            ...
            <el-table-column prop="estateShare" label="房产是否共有" min-width="120">
              <template slot-scope="scope">
                <el-select v-model="scope.row.estateShare" placeholder="请选择">
                  <el-option v-for="item in estateShares" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="buyDate" label="房产购买时间" min-width="140">
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.buyDate" type="date">
                </el-date-picker>
              </template>
            </el-table-column>
          </el-table>
      ...
      <el-collapse-item title="车辆信息" name="2">
        <template slot="title">
          ...
          <div class="title_icon">
            <span @click.stop="add_vehicle">
              <i class="title_icon_img addIcon"></i>
              <span class="title_icon_span">添加</span>
            </span>
            <span @click.stop="delet_vehicle">
              <i class="title_icon_img deleteIcon"></i>
              <span class="title_icon_span">删除</span>
            </span>
          </div>
        ...
        <div class="carContain">
          <el-table :data="carInfoList" style="width: 100%" class="car" highlight-current-row border @current-change="carCurrentChange">
            <el-table-column type="index" :index='1' label="序号" min-width="50">
            </el-table-column>
            <el-table-column prop="carPrice" label="车辆购置价[元]" min-width="120">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.carPrice!=''" content="请输入10000-10000000"
                  placement="top">
            ...
            <el-table-column prop="isYearCheck" label="是否年检" min-width="100">
              <template slot-scope="scope">
                <el-select v-model="scope.row.isYearCheck" placeholder="请选择">
                  <el-option v-for="item in isYearChecks" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="isOperate" label="是否非运营" min-width="100">
              <template slot-scope="scope">
                <el-select v-model="scope.row.isOperate" placeholder="请选择">
                  <el-option v-for="item in isOperates" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="carModel" label="车辆型号" min-width="100">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.carModel!=''" content="车牌型号应小于40字"
                  placement="top">
            ...
            <el-table-column prop="carNo" label="车牌号码" min-width="100">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="scope.row.carNo.length<100" content="车牌号码应在100字以内"
                  placement="top">
                  <el-input v-model="scope.row.carNo" @focus="falseShow(scope.row,'carNo')" @blur="postcode(scope.row,'carNo')"
                    placeholder="请输入内容"></el-input>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column prop="buyInsur" label="车辆已购保险" min-width="120">
              <template slot-scope="scope">
                <el-select v-model="scope.row.buyInsur" placeholder="请选择">
                  <el-option v-for="item in buyInsurs" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="buyDate" label="购买时间" min-width="140">
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.buyDate" type="date">
                </el-date-picker>
              </template>
            </el-table-column>
            <el-table-column prop="carShare" label="车产是否共有" min-width="120">
              <template slot-scope="scope">
                <el-select v-model="scope.row.carShare" placeholder="请选择">
                  <el-option v-for="item in carShares" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="carMortgage" label="车产是否抵押" min-width="120">
              <template slot-scope="scope">
                <el-select v-model="scope.row.carMortgage" placeholder="请选择">
                  <el-option v-for="item in carMortgages" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
      ...
      <el-collapse-item title="信用卡使用明细" name="3">
        <template slot="title">
          <i class="collapse_title_icon"></i>
          <span class="collapse_title_text">信用卡使用明细</span>
          <div class="title_icon">
            <span @click.stop="add_card">
              <i class="title_icon_img addIcon"></i>
              <span class="title_icon_span">添加</span>
            </span>
            <span @click.stop="delet_card">
              <i class="title_icon_img deleteIcon"></i>
              <span class="title_icon_span">删除</span>
            </span>
          </div>
        ...
        <div class="cardContain">
          <el-table :data="cardDetList" style="width: 100%" class="card" highlight-current-row border @current-change="cardCurrentChange">
            <el-table-column type="index" :index='1' label="序号" min-width="50">
            </el-table-column>
            <el-table-column prop="bankName" label="银行名称" min-width="160">
              <template slot-scope="scope">
                ...
                <span class="must">*</span>
                <el-tooltip class="item" effect="dark" :disabled="scope.row.bankName!=''" content="该项为必填项且长度小于60字"
                  placement="right">
                  <el-input v-bind:title="scope.row.bankName" v-model="scope.row.bankName" @focus="falseShow(scope.row,'bankName')"
                    @blur="postcode(scope.row,'bankName')" placeholder="请输入内容"></el-input>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column prop="cardUseDate" label="开卡日期" min-width="140">
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.cardUseDate" type="date">
                </el-date-picker>
              </template>
            </el-table-column>
            <el-table-column prop="cardAmt" label="信用额度" min-width="100">
              <template slot-scope="scope">
                <el-input v-model="scope.row.cardAmt" @blur="moneyBlur(scope.row,'cardAmt')" placeholder="请输入内容"></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="usedAmt" label="已使用额度" min-width="100">
              <template slot-scope="scope">
                <el-input v-model="scope.row.usedAmt" @blur="moneyBlur(scope.row,'usedAmt')" placeholder="请输入内容"></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="repayDay" label="还款日" min-width="140">
              <template slot-scope="scope">
                <el-date-picker v-model="scope.row.repayDay" type="date">
                </el-date-picker>
              </template>
            </el-table-column>
            <el-table-column prop="actRepaymentAmt" label="本期应还款金额" min-width="120">
              <template slot-scope="scope">
                <el-input v-model="scope.row.actRepaymentAmt" @blur="moneyBlur(scope.row,'actRepaymentAmt')"
                  placeholder="请输入内容"></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="realRepaymentAmt" label="本期实际还款金额" min-width="140">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" :disabled="!scope.row.realRepaymentAmtShow" content="应小于本期应还款金额"
                  placement="top">
                  <el-input v-model="scope.row.realRepaymentAmt" @blur="moneyBlur(scope.row,'realRepaymentAmt')"
                    placeholder="请输入内容"></el-input>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column prop="isOverdue" label="是否逾期" min-width="100">
              <template slot-scope="scope">
                <el-select v-model="scope.row.isOverdue" placeholder="请选择">
                  <el-option v-for="item in isOverdues" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </template>
            </el-table-column>
            <el-table-column prop="currOverdueTimes" label="当前逾期期数" min-width="110">
              <template slot-scope="scope">
                <el-input v-model="scope.row.currOverdueTimes" @blur="postcode(scope.row,'currOverdueTimes')"
                  placeholder="请输入内容"></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="maxOverdueTimes" label="最高逾期期数" min-width="110">
              <template slot-scope="scope">
                <el-input v-model="scope.row.maxOverdueTimes" @blur="postcode(scope.row,'maxOverdueTimes')" placeholder="请输入内容"></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="overdueTimes" label="近12个月累计逾期次数" min-width="170">
              <template slot-scope="scope">
              ...
              <template slot-scope="scope">
                ...
                <el-tooltip class="item" effect="dark" :disabled="scope.row.accountStatus!=''" content="该项为必填项"
                  ...
                  <el-select v-model="scope.row.accountStatus" placeholder="请选择">
                    <el-option v-for="item in caraccountStatuss" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </el-tooltip>
              </template>
      ...
      <el-collapse-item title="信用卡使用总况" name="4" ref="xinyongka">
        <template slot="title">
          <i class="collapse_title_icon"></i>
          <span class="collapse_title_text">信用卡使用总况</span>
        </template>
        <div class="xinyongka">
          <ul>
            <li>
              <label>信用卡张数：</label>
              <el-input v-on:blur="carNum(borCard.cardCount,'cardCount')" v-model="borCard.cardCount"></el-input>
            </li>
            <li>
              <label>正常使用张数：</label>
              <el-input v-on:blur="carNum(borCard.normalCount,'normalCount')" v-model="borCard.normalCount"></el-input>
            </li>
            <li>
              <label>呆帐数量：</label>
              <el-input v-on:blur="carNum(borCard.badDebtCount,'badDebtCount')" v-model="borCard.badDebtCount"></el-input>
            </li>
          </ul>
          <ul>
            <li>
              <label>未开卡张数：</label>
              <el-input v-on:blur="carNum(borCard.nouseCount,'nouseCount')" v-model="borCard.nouseCount"></el-input>
            </li>
            <li>
              <label>冻结数量：</label>
              <el-input v-on:blur="carNum(borCard.freezeCount,'freezeCount')" v-model="borCard.freezeCount"></el-input>
            </li>
            <li>
              <label>销户数量：</label>
              <el-input v-on:blur="carNum(borCard.cancelCount,'cancelCount')" v-model="borCard.cancelCount"></el-input>
            </li>
          </ul>
          <ul>
            <li>
              <label>已使用张数：</label>
              <el-input v-on:blur="carNum(borCard.userdCount,'userdCount')" v-model="borCard.userdCount"></el-input>
            </li>
            <li>
              <label>止付数量：</label>
              <el-input v-on:blur="carNum(borCard.stopPaymentCount,'stopPaymentCount')" v-model="borCard.stopPaymentCount"></el-input>
            </li>
          </ul>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="贷款总况" name="6">
        <template slot="title">
          <i class="collapse_title_icon"></i>
          <span class="collapse_title_text">贷款总况</span>
        </template>
        <div class="checkedInf checkedInf_li_width_triplet clearFix">
          <ul>
            <li>
              <label class="label_width_166">车贷共有笔数：</label>
              <span>{{loanInfo.carLoanTotal}}</span>
            </li>
            <li>
              <label class="label_width_166">车贷现存笔数：</label>
              <span>{{loanInfo.carLoanNoPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">车贷结清笔数：</label>
              <span>{{loanInfo.carLoanPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">信用贷总笔数：</label>
              <span>{{loanInfo.studentLoanTotal}}</span>
            </li>
            <li>
              <label class="label_width_166">信用贷现存笔数：</label>
              <span>{{loanInfo.studentLoanNoPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">信用贷结清笔数：</label>
              <span>{{loanInfo.studentLoanPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">房贷总笔数：</label>
              <span>{{loanInfo.houseLoanTotal}}</span>
            </li>
            <li>
              <label class="label_width_166">房贷现存笔数：</label>
              <span>{{loanInfo.houseLoanNoPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">房贷结清笔数：</label>
              <span>{{loanInfo.houseLoanPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">其他贷款总笔数：</label>
              <span>{{loanInfo.otherLoanTotal}}</span>
            </li>
            <li>
              <label class="label_width_166">其他贷现存笔数：</label>
              <span>{{loanInfo.otherLoanNoPayoff}}</span>
            </li>
            <li>
              <label class="label_width_166">其他贷款结清笔数：</label>
              <span>{{loanInfo.otherLoanPayoff}}</span>
            </li>
          </ul>
        </div>
      </el-collapse-item>
      <el-collapse-item title="负债信息" name="7">
        ...
        <div class="fuzhaixinxi">
          ...
          <ol class="num">
            <li class="liDiv" style="clear:both;">
      ...
      <el-collapse-item title="征信报告" name="8">
        <template slot="title">
          <i class="collapse_title_icon"></i>
          <span class="collapse_title_text">征信报告</span>
        </template>
          ...
          <ol>
            <li class="liDiv">
              ...
              <div class="require" style="display:inline-block">
                <span v-if="rptInfo.crSource != null && rptInfo.crSource.length==50">
                  <i>*</i>输入长度不能超过50</span>
                <el-input :rows="1" placeholder="请输入内容" v-model="rptInfo.crSource" :maxlength="50">
                </el-input>
              </div>
            </li>
            <li>
              ...
              <el-select v-model="rptInfo.crHasRecord" placeholder="请选择" class="unique">
                <el-option v-for="item in crHasRecords" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </li>
            <li class="liDiv">
              <label>近6个月内信用报告查询次数：</label>
              <el-input v-model="rptInfo.crRecordTimes" v-on:blur="carNum(rptInfo.crRecordTimes,'crRecordTimes')"></el-input>
            </li>
          </ol>
          <ol>
            <li>
              ...
              <div class="require">
                <span v-show="rptInfo.crContent != null && rptInfo.crContent.length==500">
                  <i>*</i>输入长度不能超过500</span>
                <el-input type="textarea" :rows="3" placeholder="请输入内容" v-model="rptInfo.crContent" :maxlength="500"
                  resize="none">
                </el-input>
              </div>
            </li>
      ...
      <el-collapse-item title="流水明细" name="9">
        ...
        <el-table :data="incomeList" style="width: 100%" class="income" highlight-current-row border @current-change="incomeCurrentChange">
          <el-table-column type="index" :index='1' label="序号" min-width="50">
          </el-table-column>
        ...
        <div class="qita">
          <ol>
            <li>
              <label>其他：</label>
              <div class="require">
                <span v-if="otherInfo.content != null && otherInfo.content.length==500">
                  <i>*</i>输入长度不能超过500</span>
    ...
    methods: {
      mountedInf() {
        ...
        if (this.isFull == false) { // 分屏
          ...
          $(".fuzhaixinxi ol li div input").css({
            'width': '100%',
            'maxWidth': '150px'
          });
          ...
          $(".zhengxunbaogao ol li div.require input").css({
            'width': '100%',
            'maxWidth': '150px'
          });
          $(".zhengxunbaogao ol:nth-of-type(1) li:nth-of-type(2) .unique").css({
            'maxWidth': '150px',
            'minWidth': '150px'
          });
          ...
          $(".wattingButton button").css({
            'margin-right': 'calc( 49.9% - 155px )'
          });
          ...
          $(".fuzhaixinxi ol.num li:nth-of-type(2)").css({
            "padding-left": 'calc( 16.6% - 175px )',
            "padding-right": 'calc( 16.6% - 184px )'
          });
          //征询报告
          ...
          if (res.data.loanDetailList != '') {
            ...
            for (var i = 0; i < this.loanDetailList.length; i++) {
              ...
              if (this.loanDetailList[i].presentRepayAmt != null) {
                this.loanDetailList[i].presentRepayAmt = this.formatNumber(this.loanDetailList[i].presentRepayAmt,
                  2, 0);
              };
              //贷款明细 本期实际还款金额 保留两位小数点
              if (this.loanDetailList[i].curMonthRepayAmt != null) {
                this.loanDetailList[i].curMonthRepayAmt = this.formatNumber(this.loanDetailList[i].curMonthRepayAmt,
                  2, 0);
              };
              //贷款明细 当前逾期金额 保留两位小数点
              if (this.loanDetailList[i].presentOverAmt != null) {
                this.loanDetailList[i].presentOverAmt = this.formatNumber(this.loanDetailList[i].presentOverAmt, 2,
                  0);
              };
            }
          };
      ...
      add_card: function (event) {
        ...
        if (this.cardDetList.length == 0) {
          ...
          if (this.cardDetList[this.cardDetList.length - 1].bankName == '' || this.cardDetList[this.cardDetList.length -
              1].accountStatus == '') {
            return
          } else {
            this.cardDetList.push({
      ...
      add_loanDetail: function (event) {
        ...
        if (this.loanDetailList.length == 0) {
          ...
          if (this.loanDetailList[this.loanDetailList.length - 1].loanType == '' || this.loanDetailList[this.loanDetailList
      ...
      sure() {
        ...
        for (var i = 0; i < this.loanDetailList.length; i++) {
          if (this.loanDetailList[i].loanType == '' || this.loanDetailList[i].guaranteeType == '' || this.loanDetailList[
              i].accountStatus == '') {
            this.info = "贷款明细不能为空！"
            this.blankHint();
            return
      ...
      //弹框确认
      trueSure() {
        if (this.loanInfo.carLoanTotal != '' || this.loanInfo.studentLoanTotal != '' || this.loanInfo.houseLoanTotal !==
          '' || this.loanInfo.otherLoanTotal != '') {
          () => this.countNum(event)
        };
