<template>
  <div class="CreditForm" ref="childCOmp">
<!-- 分两部分加载，点击加载div 加载第二部分，未完成测试版 -->
我是信审表22
    <div>
...
console.log('dddddddddddddddddddddddddddddddddd')
  ...
  console.log(scrollTop)
      ...
      Imgscroll() {
        ...
        this.$refs.CreditFormwwww.onmousewheel = (event) => {
          ...
          // console.log(event)
          console.log('子组件高度' + this.$refs.childCOmp.clientHeight)
          console.log('第一部分top' + this.$refs.CreditFormwwww.scrollTop)
          console.log('第一部分div高度' + this.$refs.CreditFormwwww.scrollHeight)
