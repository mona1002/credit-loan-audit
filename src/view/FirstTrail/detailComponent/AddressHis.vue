...
<template>
  <div>
    <el-form ref="form" label-width="150px">
      ...
      <!-- v-show=source=='02' -->
      <el-form-item label="其它来源情况说明:" class="item-column3" v-show="mobileData.source=='02'">
      ...
      <div style="padding-left:30px">
        ...
        <el-form-item label="异常说明:" class="item-column2" v-show="mobileData.threeQueries=='1'">
          {{mobileData.exceptionState}}
        </el-form-item>
        <!-- 是否与家庭联系人为同一接听人 -->
        <el-form-item label="是否与家庭联系人为同一人接听:" class="item-column2 line2-class">
          {{mobileData.issameFamDes}}
        </el-form-item>
        <!-- v-show="mobileData.issameFam=='0'" -->
        <el-form-item label="说明:" class="item-column2" v-show="mobileData.issameFam=='0'">
        ...
        <el-form-item label="说明:" class="item-column2" v-show="mobileData.checkWork=='01'">
