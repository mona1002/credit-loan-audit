  ...
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
      ...
      <ul style="margin-left:15px;">
        ...
        <li class="clearFix">
          <el-form-item label="三方查询是否异常：" prop="AddthreeQueries">
            <!-- <label class=" label_140"><span class="required_Red"> * </span>三方查询是否异常：</label> -->
            <el-tooltip class="item" effect="dark" content="该输入项为必填项" placement="right-end">
              <el-select v-model="ruleForm.AddthreeQueries" @change="changes('AddthreeQueries')">
                <el-option label="是" value="1"></el-option>
                <el-option label="否" value="0"></el-option>
              </el-select>
            </el-tooltip>
          </el-form-item>
          <el-form-item v-if="ruleForm.AddthreeQueries=='1'" label="说明：" prop="AddexceptionState" :label-width="label_140">
            <!-- <label class=" label_140">说明：</label> -->
            <el-tooltip class="item" effect="dark" content="该输入项为必填项" placement="right-end">
              <el-input v-model="ruleForm.AddexceptionState" type="textarea" :rows="2" resize=none :maxlength="100"></el-input>
            </el-tooltip>
          </el-form-item>
        </li>
        <li class="clearFix">
          <el-form-item>
            <label class=" label_140">是否与家庭联系人为同一人接听：</label>
            <el-select v-model="AddissameFam" @change="changes('AddissameFam')">
              <el-option label="是" value="1"></el-option>
              <el-option label="否" value="0"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item v-show="AddissameFam=='0'" label="说明：" :label-width="label_140">
            <!-- <label class=" label_140">说明：</label> -->
            <el-input v-model="AddissameFamtxt" type="textarea" :rows="2" resize=none :maxlength="100"></el-input>
          </el-form-item>
        </li>
        ...
        <li class="clearFix">
          ...
          <el-form-item label="核对子女情况：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="AddcheckAddr=='01'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="AddcheckEstate=='00'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="AddotherIncome=='00'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="AddrecentLargespend=='00'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="Addparents=='01'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="Addbrother=='00'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="Addexpenses=='00'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          ...
          <el-form-item v-show="AddcheckHometel=='01'" label="说明：" :label-width="label_140">
        ...
        <li class="clearFix">
          <el-form-item prop="Addconclusion">
            <label class=" label_140"><span class="required_Red"> * </span>调查结果：</label>
            <el-tooltip class="item" effect="dark" content="该输入项为必填项" placement="right-end">
              <el-input v-model="ruleForm.Addconclusion" type="textarea" :rows="5" resize=none :maxlength="500"></el-input>
            </el-tooltip>
          </el-form-item>
        </li>
        <!-- <div class="content-ul">
  ...
  export default {
    data() {
      return {
        ...
        ruleForm: {
          ...
          AddthreeQueries: this.Addlist.AddthreeQueries,
        },
        rules: {
          Addconclusion: [{
            required: true,
          ...
          if (valid) {
            ...
            this.post('/creTelResearchHis/addHomeTelLog', {
              ...
              cretelhometel: {
                ...
                threeQueries: this.ruleForm.AddthreeQueries,
                // exceptionState: this.AddexceptionState, // 三方异常项说明
                exceptionState: this.ruleForm.AddexceptionState, // 三方异常项说明
                ...
                conclusion: this.ruleForm.Addconclusion, // 调查结果
        ...
        switch (flage) {
          ...
          case 'AddthreeQueries':
            if (this.AddthreeQueries == '0') {
              this.AddexceptionState = ''; //待删除
              this.ruleForm.AddexceptionState = '';
            }
            break;
            // 是否为同一接听人
          case 'AddissameFam':
    ...
    watch: {
      ...
      Addlist(val) {
        ...
        this.AddthreeQueries = val.threeQueries; //待删除
        this.ruleForm.AddthreeQueries = val.threeQueries;

        this.AddexceptionState = val.exceptionState; //待删除
        this.ruleForm.AddexceptionState = val.exceptionState;

        this.Addexpenses = val.expenses;
        this.AddcheckHometel = val.checkHometel;
        this.AddhobbyandBehave = val.hobbyandBehave;
        this.Addconclusion = val.conclusion; //待删除
        this.ruleForm.Addconclusion = val.conclusion;
