          ...
          <div class="CreditForm_InternetInf">
            ...
            <!-- <ul>
              ...
              <li>
                <p>
                  ...
                  <label class="InternetInf_left_label blueC" @click="NewPage(2)">
                    <span class="red"> * </span>网搜本人手机是否异常：</label>
              ...
              <li>
                <p>
                  <i class="hint"></i>
                  <label class="InternetInf_left_label blueC" @click="NewPage(2)">网搜单位名称是否异常：</label>
              ...
              <li>
                <p>
                  <i class="hint"></i>
                  <label class="InternetInf_left_label blueC" @click="NewPage(2)">网搜单位电话是否异常：</label>
              ...
              <li>
                <p>
                  <i class="hint"></i>
                  <label class="InternetInf_left_label blueC" @click="NewPage(2)">网搜现住址和房产地址是否异常：</label>
              ...
              <li>
                <p>
                  <i class="hint"></i>
                  <label class="InternetInf_left_label blueC" @click="NewPage(2)">网搜单位地址是否异常：</label>
              ...
              <li>
                <p>
                  ...
                  <label class="InternetInf_left_label blueC" @click="NewPage(3)">
                    <span class="red"> * </span>当地工商企业基本信息是否登记：</label>
              ...
              <li>
                <p>
                  <i class="hint"></i>
                  <label class="InternetInf_left_label blueC" @click="NewPage(4)">单位在全国组织代码中是否存在：</label>
            ...
            <ul>
              ...
              <!-- <li v-show="checkData.parentIsliving=='1'">
               ...
               <el-input type="text" placeholder="请输入内容" v-model="checkData.fconsumption" @blur="formatSC('开销')">
                ...
                <el-form-item label="是否有兄弟姐妹备注：">
                     <i class="hint">
                    <b v-show="this.Wordhint.family.siblings" class="internet_textarea"> 输入长度不能超过200</b>
                  </i>
                <el-input type="textarea" :rows="2" resize="none" :maxlength="this.shotTextareaL" placeholder="请输入内容"
            ...
            <!-- <ul>
              ...
              <li v-show=" this.marriage.couple">
                ...
                <p v-show="this.marriage.workingLivingInf">
                  <i class="hint">
                    <b v-show="this.Wordhint.family.SameCity" class="internet_textarea"> 输入长度不能超过200</b>
                  </i>
