                ...
                <div>
                  <div class="height_auto">
                    <el-table :data="listData.recordList" border @row-dblclick="rowDbClick" v-loading="mobileLoading" highlight-current-row>
                      ...
                      <el-table-column prop="checkTime" label="调查时间" width="160">
                      </el-table-column>
  ...
  export default {
    ...
    watch: {
      ...
      addTelNum: function (value) {
        ...
        this.addTelRex = this.landLinePhoneLength.test(value);
        // 判断 显示 电话格式
        ...
        // ) {
        if (((this.addTelType == '01' || this.addTelType == '02') && this.addTelType.length > 0 && this.addTelName.length >
            0 && this.addTelNum.length >= 21 && !this.addTelRex) ||
          ((this.addTelType == '03' || this.addTelType == '04' || this.addTelType == '05') && this.addTelType.length >
            0 && this.addTelName.length > 0 && this.addRelationShip.length > 0 && this.addTelNum.length >= 14 && !
            this.addTelRex)
        ) {
          this.active = false;
          this.$message({
        ...
        if (((this.addTelType == '01' || this.addTelType == '02') && this.addTelType.length > 0 && this.addTelName.length >
          ...
          // if( value.charAt(0)!=1){
          // if(!this.landLinePhoneLength.test(value)){
          ...
          //   if(value.length==11){
          // if( !this.mobilePhone.test(value)){
          //     this.$message({
          //               message:'请输入正确的电话号码或座机号码（xxx-xxxxxxx）！',
          //               type: 'warning'
          //             }); 
          ...
          //         }); 
          //     }
          // else if(value.charAt(0)==1 &&value.charAt(1)*1<3 &&value.charAt(1)!=''&&this.addTelNum.length ==11 ){
          //       this.$message({
          //            message:'请输入正确的电话号码或座机号码（xxx-xxxxxxx）！',
          //             type: 'warning'
          //           }); 
    ...
    methods: {
      mountedInf() {
        ...
        //质检详情-部分
        if (this.judgeFlag == '07' || this.judgeFlag == '08' || this.judgeFlag == '09' || this.judgeFlag == '10' ||
          this.judgeFlag == '11' || this.judgeFlag == '12' || this.judgeFlag == '13') {
