        ...
        <div class="CreditForm_InternetInf">
          ...
          <ul class="CreditForm_InternetInf_ul_right">
            ...
            <li>
              ...
              <span class="detail_inf">{{this.netHirecomtxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 失信记录说明： </label>
              <span class="detail_inf">{{this.netEcutedBreatxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 单位失信记录说明： </label>
              <span class="detail_inf">{{this.netHirecomBreatxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 手机异常信息说明： </label>
              <span class="detail_inf">{{this.netPhonetxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 单位名称异常信息说明： </label>
              <span class="detail_inf">{{this.netHirecomNametxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 单位电话异常信息说明： </label>
              <span class="detail_inf">{{this.netHirecomPhonetxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 地址异常信息说明： </label>
              <span class="detail_inf">{{this.netAddrandEstatetxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 单位地址异常信息说明： </label>
              <span class="detail_inf">{{this.netHirecomAddresstxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 工商登记信息说明： </label>
              <span class="detail_inf">{{this.netCompanytxt }} </span>
            </li>
            <li>
              <label class="InternetInf_right_label"> 组织机构代码信息说明： </label>
              <span class="detail_inf">{{this.netAddrstatetxt }} </span>
            </li>
          </ul>
        </div>
      </el-collapse-item>
        ...
        <div class="CreditForm_CheckId">
          <ul class="CreditForm_CheckId_ul_left">
            <li>
              ...
              <span class="detail_inf">{{this.isselfVal }} </span>
            </li>
            <li>
              <label class="CheckId_left_label">是否在我司申请借款：</label>
              <span class="detail_inf">{{this.loanBeforeVal }} </span>
            </li>
          </ul>
          <ul class="CreditForm_CheckId_ul_right">
            <li>
              <label class=" CheckId_right_label "> 接听说明： </label>
              <span class="detail_inf">{{this.isselftxt }} </span>
            </li>
          </ul>
        </div>
      </el-collapse-item>
        ...
        <div class="CreditForm_WorkInfs">
          <ul class="CreditForm_WorkInfs_ul_left">
            ...
            <li>
              ...
              <span class="detail_inf">{{this.hirecomSignVal }} </span>
            </li>
            <li>
          ...
          <ul class="CreditForm_WorkInfs_ul_right">
            ...
            <li>
              ...
              <span class="detail_inf">{{this.hirecomGetjob }} </span>
            </li>
            <li>
              <label class=" CheckId_right_label "> 工资发放形式： </label>
              <span class="detail_inf">{{this.hirecomPaymentTypeVal }} </span>
            </li>
            <li>
              <label class=" CheckId_right_label "> 单位地址邮编： </label>
              <span class="detail_inf">{{this.hirecomPostcode }} </span>
            </li>
            <li>
        ...
        <div class="CreditForm_CompanyInfs">
          <ul class="CreditForm_CompanyInfs_ul_left">
            <li>
              ...
              <span class="detail_inf">{{this.selfTypeVal }} </span>
            </li>
            <li>
          ...
          <ul class="CreditForm_CompanyInfs_ul_right">
            ...
            <li>
              ...
              <span class="detail_inf">{{this.profitamountmamtVal }} </span>
            </li>
            <li>
              <label class=" CheckId_right_label "> 第一分销商： </label>
              <span class="detail_inf">{{this.selfFirdistri }} </span>
            </li>
          </ul>
        </div>
      </el-collapse-item>
        ...
        <div class="CreditForm_FamilyInf">
          <ul class="CreditForm_FamilyInf_ul_left">
            <li>
              ...
              <span class="detail_inf">{{this.fmarrflagVal }} </span>
            </li>
            <li>
        ...
        <div class="CreditForm_live">
          <ul class="CreditForm_live_ul_left">
            <li>
              ...
              <span class="detail_inf">{{this.livingHouseHoldsVal }} </span>
            </li>
          </ul>
          <ul class="CreditForm_live_ul_left">
            <li>
              <label class="live_right_label family_left_margin_half_two">居住房产所属情况：</label>
              <span class="detail_inf">{{this.livingEstateBelongsVal }} </span>
            </li>
          </ul>
        </div>
      </el-collapse-item>
