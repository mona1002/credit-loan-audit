    ...
    <div class="content">
      ...
      <div class="table_wrap">
        ...
        <el-table :data="tableData" style="width: 100%" height="100%" border>
          ...
          <el-table-column prop="custName" label="客户名称" align='center' min-width="70">
          </el-table-column>
          <el-table-column prop="certCode" label="证件号码" align='center' min-width="180">
          </el-table-column>
          <el-table-column prop="appOrgCode" label="进件机构" align='center' min-width="70">
          </el-table-column>
          <el-table-column prop="proName" label="产品名称" align='center' min-width="70">
          </el-table-column>
          <el-table-column prop="activationTime" label="进入本环节时间" align='center' min-width="160">
          </el-table-column>
          <el-table-column prop="completeTime" label="本环节处理时间" align='center' min-width="160">
          </el-table-column>
          <el-table-column prop="processStartDate" label="流程发起时间" align='center' min-width="160">
          </el-table-column>
          <el-table-column prop="processEndDate" label="流程结束时间" align='center' min-width="160">
          </el-table-column>
        </el-table>
        <!-- 分页  -->
        <div class="paging">
