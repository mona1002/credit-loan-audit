    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item name="2">
        ...
        <div class="lists">
          ...
          <h4>保险费用 obj.baseInfoStr.insurances</h4>
          <ul>
          ...
          <h4>保险费用记录 obj.baseInfoStr.insurance_record</h4>
          <ul>
          ...
          <h4>医疗保险记录 obj.baseInfoStr.medical_insurance_record </h4>
          <ul>
    ...
    <el-collapse v-model="activeNames">
      <el-collapse-item name="3">
        ...
        <div class="lists">
          ...
          <h4>医疗保险缴存信息 obj.reportInfoStr.medical_insurance_bill.medical_insurance_pay</h4>
          <ul>
          ...
          <h4 style="color:red">医保消费明细</h4>
          <h4>医保卡消费记录 obj.reportInfoStr.medical_consumption_details.medical_consumption_record.securities_report</h4>
          <ul>
          ...
          if (this.parameterID) {
            ...
            this.post(baseurl +
              ...
              if (res.success) {
                ...
                this.base = JSON.parse(this.baseInf.base_info);
                this.insurances = JSON.parse(this.baseInf.insurances);
                this.insurance_record = JSON.parse(this.baseInf.insurance_record);
                this.medical_insurance_record = JSON.parse(this.baseInf.medical_insurance_record);
            ...
            this.post(baseurl +
              ...
              //   console.log(res)
              if (res.success == true && res.obj) {
                this.reportInf = JSON.parse(res.obj.reportInfoStr);
                this.ReportBase = this.reportInf.basic_info.user_basic_info; //用户及账户基本信息
                this.ReportBaseCheck = this.reportInf.basic_info.user_basic_info_check; //用户基本信息校验
