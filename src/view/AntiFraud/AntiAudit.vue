      ...
      <div class="SplitScreen_wrap">
        ...
        <div class="right" ref="rRight">
          ...
          <div class="tab2_Content">
            ...
            <InternalMatch v-if=" this.tabContent2==2" :SplitS="SplitRight"></InternalMatch>
            ...
            <PhoneCredit v-if=" this.tabContent2==5" :SplitS="SplitRight"></PhoneCredit>
...
<script>
  ...
  import AudioVisualLeft from "../FirstTrail/detailComponent/AudioVisualLeft.vue";
